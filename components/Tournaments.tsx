...
export const Tournaments: React.FC = () => {
  return (
    <section className="py-24 bg-gg-medium relative">
      <div className="container mx-auto px-4 max-w-5xl">
        <h2 className="text-4xl font-heading font-bold text-center mb-16 text-white">TOURNAMENTS & EVENTS</h2>
            ...
            {events.map((event, index) => (
              ...
              >
                ...
                <motion.div 
                  ...
                  className="w-full md:w-5/12 bg-gg-dark p-6 rounded-xl border border-gray-800 hover:border-gg-purple transition-all duration-300 shadow-xl"
                >
                  ...
                  {event.status !== 'COMPLETED' && (
                    <button className="mt-4 w-full py-2 bg-white/5 hover:bg-white/10 text-white rounded font-bold transition-colors text-sm">
